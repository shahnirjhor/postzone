    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="m-b-0 text-white">@lang('Edit Facebook App')</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('facebook-apps.update', $facebookApp) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="form-body">
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group @error('app_name') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="app_name" value="{{ old('app_name', $facebookApp->app_name) }}" id="app_name" type="text" placeholder="@lang('Type Your App Name Here')" required>
                                    @error('app_name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('api_id') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="api_id" value="{{ old('api_id', $facebookApp->api_id) }}" id="api_id" type="text" placeholder="@lang('Type Your Api Id Here')" required>
                                    @error('api_id')
                                        <small class="form-control-feedback">
                                            {{ $message }}
                                        </small>
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group @error('api_secret') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="api_secret" value="{{ old('api_secret', $facebookApp->api_secret) }}" id="api_secret" type="text" placeholder="@lang('Type Your App Secret Here')" required>
                                    @error('api_secret')
                                        <small class="form-control-feedback">
                                            {{ $message }}
                                        </small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('status') has-danger @enderror">
                                    ...
                                    <select id="status" class="form-control custom-select" name="status">
                                        <option value="1" {{ old('status', $facebookApp->status) === 1 ? 'selected' : '' }}>@lang('Active')</option>
                                        <option value="0" {{ old('status', $facebookApp->status) === 0 ? 'selected' : '' }}>@lang('Inactive')</option>
                                    </select>
                                    @error('status')
                                        <small class="form-control-feedback">
                                            {{ $message }}
