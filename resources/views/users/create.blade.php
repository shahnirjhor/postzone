    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="m-b-0 text-white">@lang('Create User')</h4>
            </div>
            <div class="card-body">
                <form id="userQuickForm" action="{{ route('users.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group @error('name') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="name" value="{{ old('name') }}" id="name" type="text" placeholder="@lang('Type Your Name Here')" required>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('email') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="email" value="{{ old('email') }}" id="email" type="text" placeholder="@lang('Type Your Email Here')" required>
                                    @error('email')
                                        <small class="form-control-feedback">
                                            {{ $message }}
                                        </small>
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group @error('password') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="password" value="{{ old('password') }}" id="password" type="text" placeholder="@lang('Type Your Password Here')" required>
                                    @error('password')
                                        <small class="form-control-feedback">
                                            {{ $message }}
                                        </small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('password_confirmation') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="password_confirmation" value="{{ old('password_confirmation') }}" id="password_confirmation" type="text" placeholder="@lang('Type Your Confirm Password Here')" required>
                        ...
                        <div class="row p-t-20">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('phone') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="phone" value="{{ old('phone') }}" id="phone" type="text" placeholder="@lang('Type Phone Number Here')">
                                    @error('phone')
                                        <small class="form-control-feedback">
                                            {{ $message }}
                                        </small>
