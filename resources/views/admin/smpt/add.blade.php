    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="m-b-0 text-white">@lang('Add New Smtp')</h4>
            </div>
            <div class="card-body">
                <form id="userQuickForm" action="{{ route('smtp.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="row p-t-20">
                            <div class="col-md-12">
                                <div class="form-group @error('email_address') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="email_address" value="{{ old('email_address') }}" id="email_address" type="text" placeholder="@lang('Please Type Your SMTP Email')" required>
                                    @error('email_address')
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group @error('smtp_host') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="smtp_host" value="{{ old('smtp_host') }}" id="smtp_host" type="text" placeholder="@lang('Please Type Your SMTP Host')" required>
                                    @error('smtp_host')
                                        <small class="form-control-feedback">
                                            {{ $message }}
                                        </small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('smtp_port') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="smtp_port" value="{{ old('smtp_port') }}" id="smtp_port" type="text" placeholder="@lang('Please Type Your SMTP Port')" required>
                                    @error('smtp_port')
                                        <small class="form-control-feedback">
                                            {{ $message }}
                                        </small>
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group @error('smtp_user') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="smtp_user" value="{{ old('smtp_user') }}" id="smtp_user" type="text" placeholder="@lang('Please Type Your Smtp User')" required>
                                    @error('smtp_user')
                                        <small class="form-control-feedback">
                                            {{ $message }}
                                        </small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('smtp_password') has-danger @enderror">
                                    ...
                                    <input class="form-control" name="smtp_password" value="{{ old('smtp_password') }}" id="smtp_password" type="text" placeholder="@lang('Please Type Your SMTP Password')" required>
                                    @error('smtp_password')
                                        <small class="form-control-feedback">
                                            {{ $message }}
                                        </small>
